    ...
    <div className="min-h-screen w-full" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <main className="mx-auto max-w-[1180px] px-4 py-20 md:px-0 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          <h1 className="text-5xl font-bold" style={{ fontFamily: 'var(--font-heading)', color: 'var(--foreground)' }}>Financial Solutions</h1>
          <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--foreground-muted)' }}>
            Enterprise-grade banking solutions tailored for scaling businesses and security-conscious individuals.
          </p>
          <div className="pt-8">
