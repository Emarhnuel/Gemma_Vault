    ...
    <div className="min-h-screen w-full" style={{ backgroundColor: 'var(--background)' }}>
      ...
      <main className="mx-auto max-w-[1180px] px-4 py-20 md:px-0 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          <h1 className="text-5xl font-bold" style={{ fontFamily: 'var(--font-heading)', color: 'var(--foreground)' }}>The GemmaVault Product</h1>
          <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--foreground-muted)' }}>
            A comprehensive suite of financial tools including virtual cards, instant transfers, and an AI-powered assistant.
          </p>
          <div className="pt-8">
